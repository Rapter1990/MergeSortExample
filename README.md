...
<ul>
  <li>Merge sort is a divide-and-conquer algorithm, which recursively calls itself on halved portions of the initial collection. It also divides input array in two halves, calls itself for the two halves and then merges the two sorted halves.</li>
  <li>This java example shows how to sort an element of Java ArrayList using Merge Sort method of Collections class.</li>
</ul>
